    ...
    return (
        ...
        <div>
            ...
            <div className="basis-full relative">
                ...
                <span className="rounded-full bg-slate-200 h-6 w-6 inline-flex absolute right-24 top-32"></span>
                <span className="rounded-full bg-slate-200 h-3 w-3 inline-flex absolute right-32 top-40"></span>
            ...
            <div className="basis-full relative">
                ...
                <span className="rounded-full bg-slate-200 h-6 w-6 inline-flex absolute right-24 top-24 md:top-32"></span>
                <span className="rounded-full bg-slate-200 h-3 w-3 inline-flex absolute right-32 top-32 md:top-40"></span>
