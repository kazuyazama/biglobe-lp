...
const Onayami = () => {
    return (
        ...
        <div>
            ...
            <h1 className="text-center text-xl tracking-widest lg:text-3xl py-20 font-bold before:content-['Problem'] before:text-6xl before:absolute before:-translate-y-10 before:inset-x-2 before:opacity-10">
                こんなお悩みありませんか？
            </h1>
            ...
            <div className="basis-full relative">
                ...
                {/* <span className="border-b-[30px] lg:border-t-[30px] border-b-base-100 border-r-[0px] lg:border-r-[30px] 
            ...
            <div className="relative">
             ...
             <div className="w-full border-t-[100px] md:border-t-[180px] lg:border-t-[240px]  border-t-base-100 border-r-[300px] md:border-r-[1100px] 
