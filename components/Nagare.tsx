...
const Nagare = () => {
    return (
        ...
        <div className="flex flex-col md:flex-row justify-evenly items-center space-y-5 md:space-y-0">
            ...
            <figure className="bg-primary"><Image src="/images/main/web申し込み.svg" alt="お申し込み" width={300} height={200} /></figure>
            ...
            <div className="basis-1/5">
            <div className="card card-compact bg-base-100 shadow-xl h-96">
            <figure className="bg-primary"><Image src="/images/main/内容確認連絡.svg" alt="確認" width={300} height={200} /></figure>
            ...
            <div className="basis-1/5">
            <div className="card card-compact bg-base-100 shadow-xl  h-96">
            <figure className="bg-primary"><Image src="/images/main/工事.svg" alt="開通工事" width={300} height={200} /></figure>
            <div className="card-body items-center text-center">
            ...
            <div className="card card-compact bg-base-100 shadow-xl h-96">
            <figure className="bg-primary"><Image src="/images/main/開通.svg" alt="利用開始" width={300} height={200} /></figure>
            <div className="card-body items-center text-center">
