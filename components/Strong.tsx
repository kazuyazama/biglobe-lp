...
const Strong = () => {
    return (
        ...
        <div className="flex-col md:flex md:flex-row justify-evenly space-y-10 md:space-y-0 md:space-x-10 ">
            ...
            <figure className="bg-gradient-to-r from-cyan-500 to-blue-500"><Image src="/main/strong/信頼2.svg" alt="顧客からの信頼" width={250} height={250}  /></figure>
            ...
            <div className="card md:w-1/3 bg-base-100 shadow-xl hover:-translate-y-3 ease-in-out duration-700">
                <figure className="bg-gradient-to-r from-cyan-500 to-blue-500"><Image src="/main/strong/最短.svg" alt="最短2分でのお申し込み" width={250} height={250}/></figure>
                <div className="card-body">
            ...
            <div className="card md:w-1/3 bg-base-100 shadow-xl hover:-translate-y-3 ease-in-out duration-700">
            <figure className="bg-gradient-to-r from-cyan-500 to-blue-500"><Image src="/main/strong/お得.svg" alt="最大3,5万円お得" width={200} height={250} /></figure>
