...
const Strong = () => {
    return (
        <div>
        <h1 className="text-center text-xl md:text-2xl py-20 font-semibold before:content-['Strong'] before:text-7xl before:absolute before:-translate-y-10 before:inset-x-2 before:opacity-10">当サイトが選ばれる理由</h1>
