...
const Flow = () => {
    return (
        <>
        <div className="text-center text-xl tracking-widest md:text-3xl py-20 font-bold before:content-['Flow'] before:text-7xl before:absolute before:-translate-y-10 before:inset-x-2 before:opacity-10"><h1>利用までの流れ</h1></div>
