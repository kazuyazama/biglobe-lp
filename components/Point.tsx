        ...
        <div className="grid grid-cols-2 justify-items-center gap-y-10 border-4 py-10 px-4 lg:px-10 bg-base-100 rounded-xl ">
          ...
          <div className="col-span-2">
            <p className="text-xs lg:text-sm text-justify leading-relaxed">
              ...
              4
              ビッグローブ光3年プランの場合の料金です。ビッグローブ光3年自動更新プランの場合、契約期間は3年間です。契約期間満了月の末日までに解約が完了しなかった場合、本サービスの契約は3年単位での自動更新となります。契約期間満了月の当月・翌月・翌々月以外で解約をされた場合、ファミリータイプ：4230円　マンションタイプ：3360円を解除料（不課税）としてご請求します。但し、お引っ越し先でも継続して利用
              していただく場合は解除料は発生しません。 5
              工事費用は別途発生いたします。
            </p>
          </div>
