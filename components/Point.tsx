...
const Point = () => {
    return (
        ...
        <h1 className="text-center text-xl tracking-widest lg:text-3xl pb-10 pt-16 lg:pt-32 lg:pb-20 font-bold before:content-['Point'] before:text-6xl before:absolute before:-translate-y-10 before:inset-x-2 before:opacity-10">ビッグローブ光なら解決！４つのポイント</h1>
        ...
        <div className="grid grid-cols-2 justify-items-center gap-y-10 border-4 py-10 px-4 lg:px-10 bg-base-100 rounded-xl ">
            ...
            <div className="pl-4 lg:pl-10"><FaRegBuilding  className="text-4xl lg:text-7xl" /></div>
            <div className="card-body items-center px-0">
                <h2 className="card-title">マンションタイプ</h2>
                <h1 className="font-semibold self-center"><span className="text-2xl lg:text-5xl text-secondary pr-2">4,378円</span>円 / 月</h1>
            ...
            <div className="card card-side bg-sky-50 shadow-2xl items-center border-2 border-primary card-compact lg:py-2">
            <div className="pl-4 lg:pl-10"><BsHouse className="text-4xl lg:text-7xl" /></div>
            <div className="card-body items-center px-0">
                <h2 className="card-title">戸建タイプ</h2>
                <h1 className="font-semibold self-center"><span className="text-2xl lg:text-5xl text-secondary pr-2">5,478円</span>円 / 月</h1>
        ...
        <h1 className="text-xl lg:text-2xl font-semibold whitespace-nowrap">スマホとセットでよりお得に!</h1>
        </div>
        ...
        <h1 className="text-xl lg:text-2xl font-semibold ">IPv6対応で速度が速い</h1>
        </div>
        ...
        <div className="grid grid-cols-2 justify-items-center gap-y-10  py-10 px-4 lg:px-10 border-4 bg-base-100 rounded-xl  ">
            ...
            <div className="col-span-2">
            <h3 className="lg:text-lg">回線速度はフレッツ光と同じ最大1Gbpsだから快適！</h3>
            </div>
        ...
        <h1 className="text-xl lg:text-2xl font-semibold whitespace-nowrap">引っ越しも安心!移転費用無料</h1>
        </div>
