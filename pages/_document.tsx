    ...
    <Html lang="ja" data-theme="cmyk">
      <Head>
        ...
        <link
          ...
          sizes="180x180"
          href="/logo/favicons/apple-touch-icon.png"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="32x32"
          href="/logo/favicons/favicon-32x32.png"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="16x16"
          href="/logo/favicons/favicon-16x16.png"
        />
        <link rel="manifest" href="/logo/favicons/site.webmanifest" />
        <link
          rel="mask-icon"
          href="/logo/favicons/safari-pinned-tab.svg"
          color="#5bbad5"
        />
